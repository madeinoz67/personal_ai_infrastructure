...
import { setupTestEnvironment, cleanupTests } from "../../setup.ts";
...
describe("MCPClient", () => {
  ...
  describe("MCP Tool Constants", () => {
    it("should have all tool constants defined", () => {
      // These are the tool names that should be available
      const expectedTools = [
        "add_episode",
        "search_nodes",
        "search_facts",
  ...
  describe("Tool Names and Aliases", () => {
    ...
    it("should have descriptive tool names", () => {
      const toolDescriptions = {
        add_episode: "Adds a knowledge episode to the graph",
        search_nodes: "Searches for entities in the graph",
        search_facts: "Searches for relationships/facts",
